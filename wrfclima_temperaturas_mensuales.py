...
rutas_nc = ["/home/arw/salidas_raw/m1_mes1/salida.nc","/home/arw/salidas_raw/m1_mes2/salida.nc","/home/arw/salidas_raw/m1_mes3/salida.nc","/home/arw/salidas_raw/m1_mes4/salida.nc","/home/arw/salidas_raw/m1_mes5/salida.nc"]

#Se abre el netcdf
df = xr.open_dataset(rutas_nc[0])
...
tiempo_crudo=df['Times']
tiempos = ps.to_datetime(tiempo_crudo.values.astype(str), format='%Y-%m-%d_%H:%M:%S')
#-------------------------------------------------------------------------------------------------------------
...
paleta_temperatura=["012674","005ce7","73b2ff","bdd2ff","39a801","4de600","a3ff74","d1ffbe","ffff00","ffaa01","febebe","ff807f","ff5500","fe0002","a80000","730000"]
niveles_temperatura = [0,2,4,6,12,16,18,20,22,24,26,28,30,32,34,36,38,40,42,44]
